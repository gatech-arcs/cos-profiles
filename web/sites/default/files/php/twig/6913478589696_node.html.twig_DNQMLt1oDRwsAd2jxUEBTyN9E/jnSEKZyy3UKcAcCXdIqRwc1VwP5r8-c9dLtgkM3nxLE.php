...
/* themes/custom/gt_theme/templates/content/node.html.twig */
class __TwigTemplate_28d0b2466cb240284b2bb347450dc750 extends Template
{
...
";
        // line 72
        $context["classes"] = ["node", ("node--type-" . \Drupal\Component\Utility\Html::getClass(CoreExtension::getAttribute($this->env, $this->source,         // line 74
($context["node"] ?? null), "bundle", [], "any", false, false, true, 74))), (((($tmp = CoreExtension::getAttribute($this->env, $this->source,         // line 75
($context["node"] ?? null), "isPromoted", [], "method", false, false, true, 75)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? ("node--promoted") : ("")), (((($tmp = CoreExtension::getAttribute($this->env, $this->source,         // line 76
($context["node"] ?? null), "isSticky", [], "method", false, false, true, 76)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? ("node--sticky") : ("")), (((($tmp =  !CoreExtension::getAttribute($this->env, $this->source,         // line 77
($context["node"] ?? null), "isPublished", [], "method", false, false, true, 77)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? ("node--unpublished") : ("")), (((($tmp =         // line 78
...
";
    ...
    {
        return "themes/custom/gt_theme/templates/content/node.html.twig";
    }
    ...
    {
        return array (  117 => 103,  113 => 102,  110 => 101,  102 => 97,  100 => 96,  96 => 95,  92 => 94,  89 => 93,  87 => 92,  81 => 90,  73 => 87,  68 => 86,  66 => 85,  62 => 84,  57 => 82,  54 => 81,  52 => 78,  51 => 77,  50 => 76,  49 => 75,  48 => 74,  47 => 72,  44 => 70,);
    }

    public function getSourceContext(): Source
    {
        return new Source("", "themes/custom/gt_theme/templates/content/node.html.twig", "/var/www/html/web/themes/custom/gt_theme/templates/content/node.html.twig");
    }
    
    public function checkSecurity()
    {
        static $tags = ["set" => 72, "if" => 85, "trans" => 96];
        static $filters = ["clean_class" => 74, "escape" => 82];
        static $functions = [];
