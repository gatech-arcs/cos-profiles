...
class ImageOptimizerForm extends ConfigFormBase {
   ...
   * {@inheritdoc}
   */
  public function __construct(ConfigFactoryInterface $config_factory, TypedConfigManagerInterface $typed_config_manager, Api $api, VclHandler $vclHandler, Webhook $webhook, RequestStack $requestStack) {
