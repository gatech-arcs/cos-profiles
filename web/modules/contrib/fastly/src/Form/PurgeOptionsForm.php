...
class PurgeOptionsForm extends ConfigFormBase {
   ...
   * {@inheritdoc}
   */
  public function __construct(ConfigFactoryInterface $config_factory, TypedConfigManagerInterface $typed_config_manager, Webhook $webhook, RequestStack $requestStack) {
