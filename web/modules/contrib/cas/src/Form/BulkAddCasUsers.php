...
class BulkAddCasUsers extends FormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $roles = array_map(
      fn(RoleInterface $role): string => Html::escape($role->label()),
   ...
   */
  public static function userAdd(string $cas_username, array $roles, string $email_hostname, array &$context): void {
   ...
   */
  public static function userAddFinished(bool $success, array $results, array $operations): void {
