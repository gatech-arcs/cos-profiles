...
abstract class CasBrowserTestBase extends BrowserTestBase {
   ...
   */
  protected function disableRedirects(): void {
   ...
   */
  protected function enabledRedirects(): void {
   ...
   */
  protected function buildServiceUrlWithParams(array $service_url_params = []): string {
