...
class CasPasswordResetTest extends CasBrowserTestBase {
   ...
   */
  protected UserInterface $casUser;

  /**
   * A user not linked with a CAS account.
   */
  protected UserInterface $nonCasUser;
   ...
   */
  public function testPasswordResetAsAnonymous(): void {
   ...
   */
  public function testPasswordResetAsAuthenticated(): void {
    // Test with the 'user_accounts.restrict_password_management' setting off.
    $this->settings
