...
class CasBulkAddCasUsersTest extends CasBrowserTestBase {
   ...
   */
  public function testBulkAddForm(): void {
    ...
    $this->assertEquals('test 3', $casUserManager->getCasUsernameForAccount((int) $user_test3->id()));
    ...
    $this->assertEquals('test4', $casUserManager->getCasUsernameForAccount((int) $user_test4->id()));
