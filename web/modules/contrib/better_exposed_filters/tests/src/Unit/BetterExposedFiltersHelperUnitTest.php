...
class BetterExposedFiltersHelperUnitTest extends UnitTestCase {
  ...
  public function testSortOptionsCustomEdgeCases() {
    // Test empty array.
    $result = BetterExposedFiltersHelper::sortOptionsCustom([], 'alpha', 'asc', TRUE);
    $this->assertEmpty($result, 'Empty array should remain empty');

    // Test single element.
    $single = ['key' => 'value'];
    $result = BetterExposedFiltersHelper::sortOptionsCustom($single, 'alpha', 'asc', TRUE);
    ...
    $result = BetterExposedFiltersHelper::sortOptionsCustom($options, 'invalid_method', 'asc', TRUE);
